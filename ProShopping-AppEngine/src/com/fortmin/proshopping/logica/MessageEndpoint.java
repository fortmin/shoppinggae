...
import com.fortmin.proshopping.entidades.MessageData;
 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "fortmin.com", ownerName = "fortmin.com", packagePath = "proshopping"))
...
public class MessageEndpoint {
	 ...
	 */
	private static final String API_KEY = "AIzaSyC4__VzRL3Wl7a5TEW1oqjk4Ruk7ZGiPME";
	...
	/*
	 * Enviar un mensaje a un solo dispositivo
	 */
	@ApiMethod(name = "enviarMensaje", path = "enviar_mensaje")
	public void enviarMensaje(@Named("message") String message,

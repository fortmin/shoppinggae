...
public class Shopping {
     ...
     */
    @ApiMethod(name = "EstablecerClienteCerca", path = "establecer_cliente_cerca")
    public Mensaje establecerClienteCerca(@Named("elementoRf") String elemRf,
	    @Named("tipo") String tipo, @Named("usuario") String usuario) {
	EntityManager mgr = getEntityManager();
	ElementosRF elems = new ElementosRF();
	Mensaje resp = elems.establecerClienteCerca(mgr, elemRf, tipo, usuario);
	return resp;
    }
     ...
     * Establecer el cliente que hay cerca de un Tag o Beacon
     */
    @ApiMethod(name = "GetClienteCerca", path = "get_cliente_cerca")
    public Mensaje getClienteCerca(@Named("elementoRf") String elemRf,
	    @Named("tipo") String tipo) {
	EntityManager mgr = getEntityManager();
	ElementosRF elems = new ElementosRF();
	Mensaje resp = elems.getClienteCerca(mgr, elemRf, tipo);
	return resp;
    }

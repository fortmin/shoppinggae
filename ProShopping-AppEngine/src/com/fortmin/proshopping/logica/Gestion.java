...
public class Gestion {
    ...
    /*
     * Permite que el cliente canjee algunos puntos por un paquete
     */
    @ApiMethod(name = "CanjearPuntos", path = "canjear_puntos")
    public Mensaje canjearPuntos(@Named("usuario") String usuario,
	    @Named("paquete") String nompaq) {
	EntityManager mgr = getEntityManager();
	Clientes clis = new Clientes();
	Mensaje resp = clis.canjearPuntos(mgr, usuario, nompaq);
	return resp;
    }
     ...
     */
    @ApiMethod(name = "GetComprasPendienteEntrega", path = "get_compras_pendiente_entrega")
    public LinkedList<ComprasVO> getComprasPendienteEntrega() {
	EntityManager mgr = getEntityManager();
	Clientes clis = new Clientes();
	LinkedList<ComprasVO> resp = clis.getComprasPendienteEntrega(mgr);
	return resp;
    }
